...
describe('CategoryTabs', () => {
  ...
  it('tablist に controlsId を aria-controls として設定する', () => {
    const onChange = vi.fn()
    ...
    render(
      <CategoryTabs
        ...
        categories={CATEGORY_DEFINITIONS}
        onChange={onChange}
        controlsId="recommendations"
      />,
    )

    expect(screen.getByRole('tablist')).toHaveAttribute('aria-controls', 'recommendations')
  })
