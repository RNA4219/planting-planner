...
export const SearchControls = ({
  ...
  const isShareButtonDisabled = !isShareSupported && !isClipboardSupported
  ...
  const shareButtonClassName =
    'inline-flex items-center justify-center rounded-lg border border-market-info/50 bg-transparent px-3 py-2 text-sm font-semibold text-market-info shadow-sm transition hover:bg-market-info/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-market-info disabled:cursor-not-allowed disabled:opacity-70'
